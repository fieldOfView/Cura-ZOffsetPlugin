...
class ZOffsetPlugin(Extension):
    def __init__(self):
        ...
        self._settings_dict["adhesion_z_offset_extensive_processing"] = {
            ...
            "description": "Apply the Z Offset throughout the Gcode file instead of affecting the coordinate system. Turning this option on will increase the processing time so it is recommended to leave it off.",
            "type": "bool",
            "default_value": False,
